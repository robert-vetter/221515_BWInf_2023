class Polygon{
  ...
  Polygon(float x1, float y1, float x2, float y2, float x3, float y3, float x4, float y4, color cl, float vx1, float vy2, float vx3, float vy4){
    this.x1 = x1;
    this.y1 = y1;
    this.x2 = x2;
    this.y2 = y2;
  ...
  //Methode, die die Polygone auf das Canvas zeichnet
  void show(){
    fill(cl);
